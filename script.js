...
const projects = [
  ...
  },
  {
    ...
    roles: ["プロジェクトマネージャー", "モデリング", "アニメーション", "エフェクト"],
    technologies: ["Unity", "C#", "Blender"],
    description:
      "大学のサークルで8人チームを組み、開発しているアクションゲームです。チョコの特徴である「溶ける」や「他の食べ物をコーティングできる」といった要素を取り入れつつ、ポップな雰囲気のゲームにしました。プロジェクトマネージャーとして進行しながら、主にモデリング、キャラクターアニメーション、エフェクトを担当しました。",
    categories: ["games"],
