...
const projects = [
  ...
  },
  {
    ...
    roles: ["企画", "プログラミング"],
    description:
      "喜多方で毎年夏に行われるレトロ横丁で展示し、お祭りに遊びに来た方々、特に小学生を中心とした子どもたちに遊んでもらったゲームです。" +
      ...
      "また、リザルト画面ではスコアを表示せず、プリンの総移動距離やジャンプ回数などのプレイ内容に応じて、ポジティブな言葉で表彰するようにしました。どのような結果でも楽しい雰囲気で終えられるようにすることで、ゲーム操作に慣れていない小さな子どもでも前向きな気持ちで遊び終えられるよう工夫しています。",
    categories: ["games"],
